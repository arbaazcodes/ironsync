...
export function BlueprintFeatures() {
  return (
    <section id="features" className="py-24 sm:py-32 bg-background-subtle border-y border-border scroll-mt-16">
      <Container>
        {/* Section Header */}
        ...
        <div className="space-y-24 sm:space-y-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-14 items-center">
            ...
            <div className="lg:col-span-6 relative group">
              <div className="absolute -inset-2 bg-gradient-to-r from-accent/30 via-accent/10 to-transparent rounded-[32px] blur-xl opacity-50 group-hover:opacity-100 transition-opacity pointer-events-none" />
              <div className="relative rounded-[28px] overflow-hidden bg-card border border-border shadow-card hover:border-accent/40 transition-all duration-300">
                ...
                {/* Floating HUD Card */}
                <div className="p-5 sm:p-6 bg-card border-t border-border space-y-3">
                  <div className="flex items-center justify-between font-mono text-xs pb-2 border-b border-border">
                    <span className="text-accent font-bold uppercase">Compound Strength Presets</span>
                    <span className="text-primary font-bold">WEEK 4 &bull; INTENSIFICATION</span>
                  </div>
                  <div className="flex items-center justify-between text-xs font-mono">
                    <span className="text-primary font-bold">Barbell Back Squat</span>
                  ...
                  <div className="flex items-center justify-between text-[11px] font-mono text-primary-dim">
                    ...
                    <span className="text-primary font-semibold">Tempo 3-1-1-0</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <h3 className="text-3xl sm:text-4xl font-extrabold text-primary tracking-tight uppercase leading-tight">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-14 items-center">
            ...
            <div className="lg:col-span-6 relative group order-1 lg:order-2">
              <div className="absolute -inset-2 bg-gradient-to-r from-transparent via-accent/10 to-accent/30 rounded-[32px] blur-xl opacity-50 group-hover:opacity-100 transition-opacity pointer-events-none" />
              <div className="relative rounded-[28px] overflow-hidden bg-card border border-border shadow-card hover:border-accent/40 transition-all duration-300">
                <div className="relative h-72 sm:h-96 w-full">
                  <img
                ...
                <div className="p-5 sm:p-6 bg-card border-t border-border space-y-3">
                  <div className="flex items-center justify-between font-mono text-xs pb-2 border-b border-border">
                    ...
                    <span className="text-primary font-bold">2,650 KCAL &bull; 175G PROTEIN</span>
                  </div>
                  <div className="grid grid-cols-3 gap-2 text-center font-mono">
                    ...
                    <div className="p-2 rounded-xl bg-surface-elevated border border-border">
                      ...
                      <span className="text-xs font-bold text-primary">310g (47%)</span>
                    </div>
                    <div className="p-2 rounded-xl bg-surface-elevated border border-border">
              ...
              <div className="relative rounded-[28px] overflow-hidden bg-card border border-border shadow-card hover:border-accent/40 transition-all duration-300">
                ...
                <div className="p-5 sm:p-6 bg-card border-t border-border space-y-3">
                  <div className="flex items-center justify-between font-mono text-xs pb-2 border-b border-border">
                    ...
                    <span className="text-primary font-bold">OPTIMAL READINESS 94%</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2 text-center font-mono">
                    <div className="p-2 rounded-xl bg-surface-elevated border border-border">
                      <span className="text-[10px] text-primary-dim block">SLEEP CADENCE</span>
                      <span className="text-xs font-bold text-primary">8h 00m Continuous</span>
                    </div>
                    <div className="p-2 rounded-xl bg-surface-elevated border border-border">
